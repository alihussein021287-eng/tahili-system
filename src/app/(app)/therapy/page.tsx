...
export default async function TherapyDashboard() {
  ...
  return <div className="space-y-5"><PageHeader title="لوحة رئيس المعالجين" subtitle="الإحالات والخطط والمواعيد ضمن مراكز عضويتك" icon="🏃"><Link href="/therapy/today" className="btn-ghost bg-white text-brand-700">جلسات المعالج اليوم</Link></PageHeader>
