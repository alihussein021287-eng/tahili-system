...
- For UI-only releases, require the governance gate and deterministic inventory result from the committed source; never accept a hidden workflow or permission change as visual cleanup.
