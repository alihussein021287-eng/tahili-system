...
للاستخدام اليومي التفصيلي راجع [الدليل العربي للأدوار](docs/USER_ROLE_GUIDE_AR.md)، [مصفوفة الصلاحيات العربية](docs/ROLE_PERMISSION_MATRIX_AR.md)، و[خريطة تسليم العمل](docs/ROLE_WORKFLOW_HANDOFFS_AR.md). هذه الملفات توثق افتراضات الكود وحدود العضوية/الحالة؛ لا تستبدل حراس Server Actions.
