...
| --- | ---: | --- |
| `VISUAL` | 72 | صفحة تشغيل فُحصت واستفادت من نظام التصميم أو مكونات الصفحة المشتركة |
...
إجمالي صفحات الواجهة `page.tsx`: **92**. إجمالي Route Handlers: **18**. إجمالي routes في الجرد: **110**.
